...
export const projects = [
	{
		...
		logo: logoReservia,
		illustrations: [reservia, reservia2],
		skillWorked: ["Intégrer du contenu conformément à une maquette", "Implémenter une interface responsive"],
	...
	},
	{
		...
		logo: logoOhmyfood,
		illustrations: [ohmyfood, ohmyfood2, ohmyfood3, animation],
		skillWorked: [
	...
	},
	{
		...
		logo: logoGameOn,
		illustrations: [GameOn, GameOn2],
		skillWorked: ["Programmer en JavaScript", "Validation formulaire"],
	...
	},
	{
		...
		logo: logoFishEye,
		illustrations: [FishEye, FishEye2, FishEye3, FishEye4],
		skillWorked: [
	...
	},
	{
		...
		description: "Développez un algorithme en JavaScript",
		logo: logoPlats,
		illustrations: [plats, plats2, plats3],
		skillWorked: ["Analyser un problème informatique", "Développer un algorithme pour résoudre un problème"],
	...
	},
	{
		...
		logo: logoBilled,
		illustrations: [billed2, billed, billed3, billed4, billed5],
		skillWorked: [
	...
	},
	{
		id: 7,
		title: "Learn at home",
		description: "Définir les besoins pour une application.",
		logo: logolearnAtHome,
		illustrations: [learnAtHome5, learnAtHome6, learnAtHome3, learnAtHome, learnAtHome2, learnAtHome4],
		skillWorked: [
	...
	},
	{
		id: 8,
		title: "Kasa",
		description: "Créer une application Web avec React et React Router",
		logo: logoKasa,
		illustrations: [kasa, kasa2, kasa3],
		skillWorked: [
	...
	},
	{
		...
		skillWorked: [
			"Créer une application Reacr",
			"Configurer un serveur avec Node et Express ",
			"Créer une base de donnée MongoDB",
			"Gestoin de requête CRUD",
		],
